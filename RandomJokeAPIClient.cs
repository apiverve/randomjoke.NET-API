...
namespace APIVerve
{
    public class RandomJokeAPIClient
    {
        ...
        public RandomJokeAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public RandomJokeAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(randomjokeQueryOptions options)
        {
            try
            {
                if (_isDebug)
